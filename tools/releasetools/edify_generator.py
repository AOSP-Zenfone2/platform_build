...
class EdifyGenerator(object):
  ...
  def FlashSuperSU(self):
    ...
    self.script.append('run_program("/xbin/busybox", "unzip", "/tmp/supersu/supersu.zip", "META-INF/com/google/android/*", "-d", "/tmp/supersu");')
    self.script.append('run_program("/xbin/busybox", "sh", "/tmp/supersu/META-INF/com/google/android/update-binary", "dummy", "1", "/tmp/supersu/supersu.zip");')
